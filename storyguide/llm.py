...
def _system_prompt(context: Dict) -> str:
    ...
    return (
        ...
        "If the raw extract mentions school enrollment, include it — but clearly distinguish "
        "between district-wide enrollment (covering K-12) and high-school-only enrollment (grades 9-12). "
        "Only call it 'high school enrollment' if the source specifies grades 9-12 specifically."
